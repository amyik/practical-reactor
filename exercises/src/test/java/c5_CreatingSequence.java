...
public class c5_CreatingSequence {
  ...
  public void interval() {
    Flux<Long> interval = Flux.interval(Duration.ofMillis(1000)); //todo: change this line only
   ...
   * <p>
   * Answer: - What is difference between `generate` and `create`? - What is difference between
   * `create` and `push`?
   */
  @Test
